...
namespace CatTennis.Rebuild.Cat
{
    public sealed class AISwingPlan
    {
        public AISwingPlan(long pointId,long planId,long observationId,long expectedStep,
            SwingKind kind,ShotIntent intent,float remaining,Vector2 intercept,bool jump, int bounces)
        { PointId=pointId;PlanId=planId;SourceObservationId=observationId;ExpectedBallStepIndex=expectedStep;
          SwingKind=kind;Intent=intent;RemainingTime=remaining;InitialRemainingTime=remaining;InterceptPosition=intercept;JumpRequired=jump; BounceCountBeforeArrival=bounces; }
        ...
        public int BounceCountBeforeArrival{get;}
    }
}
