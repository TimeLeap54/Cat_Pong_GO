...
namespace CatTennis.Rebuild.Cat
{
    ...
    public sealed class ManualHitboxTrigger : MonoBehaviour
    {
        [SerializeField] private ManualHitboxKind kind;
        [SerializeField] private BoxCollider2D box;
        [SerializeField] private PlayerManualHitboxController controller;

        public ManualHitboxKind Kind => kind;
        public BoxCollider2D Box => box;

        public void Configure(ManualHitboxKind newKind, PlayerManualHitboxController newController)
        {
            kind = newKind;
