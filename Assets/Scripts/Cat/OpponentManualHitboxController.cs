...
{
    public sealed class OpponentManualHitboxController : MonoBehaviour
    {
        [SerializeField] private Transform manualHitboxesRoot;
        [SerializeField] private OpponentManualHitboxTrigger normalHitbox;
        [SerializeField] private OpponentManualHitboxTrigger smashHitbox;
        [SerializeField] private OpponentHitDetector hitDetector;
        ...
        public OpponentManualHitboxTrigger NormalHitbox => normalHitbox;
        public OpponentManualHitboxTrigger SmashHitbox => smashHitbox;

        public void Configure(
            OpponentManualHitboxTrigger normal,
            OpponentManualHitboxTrigger smash,
        ...
        private void ConfigureTrigger(OpponentManualHitboxTrigger trigger, ManualHitboxKind kind)
        {
            if (trigger != null)
            {
        ...
        {
            OpponentManualHitboxTrigger active = GetActiveHitbox();
        ...
        private OpponentManualHitboxTrigger GetActiveHitbox()
        {
        ...
        private static void SetEnabled(OpponentManualHitboxTrigger hitbox, bool enabled)
        {
        ...
        private void DrawHitbox(OpponentManualHitboxTrigger hitbox, ManualHitboxKind kind)
        {
            if (hitbox == null || hitbox.Box == null)
            {
                return;
